export type HeldItem = { readonly kind: "quota" | "capacity"; readonly id: string; readonly key: string; readonly shop: string; readonly period?: string; readonly amount?: number };
export type HeldDecision = "commit" | "release" | "allocate" | "deallocate" | "ignore";
