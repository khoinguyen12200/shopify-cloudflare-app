...
CREATE TABLE `__new_entitlement_operations` (
	...
	CONSTRAINT "entitlement_operations_amounts_check" CHECK(typeof("__new_entitlement_operations"."requested_amount") = 'integer' AND typeof("__new_entitlement_operations"."reserved_amount") = 'integer' AND "__new_entitlement_operations"."requested_amount" >= 0 AND "__new_entitlement_operations"."requested_amount" <= 9007199254740991 AND "__new_entitlement_operations"."reserved_amount" >= 0 AND "__new_entitlement_operations"."reserved_amount" <= 9007199254740991 AND ("__new_entitlement_operations"."actual_amount" IS NULL OR (typeof("__new_entitlement_operations"."actual_amount") = 'integer' AND "__new_entitlement_operations"."actual_amount" >= 0 AND "__new_entitlement_operations"."actual_amount" <= 9007199254740991 AND "__new_entitlement_operations"."actual_amount" <= "__new_entitlement_operations"."reserved_amount"))),
...
CREATE TABLE `__new_entitlement_usage` (
	...
	CONSTRAINT "entitlement_usage_amounts_check" CHECK(typeof("__new_entitlement_usage"."committed") = 'integer' AND typeof("__new_entitlement_usage"."held") = 'integer' AND "__new_entitlement_usage"."committed" >= 0 AND "__new_entitlement_usage"."committed" <= 9007199254740991 AND "__new_entitlement_usage"."held" >= 0 AND "__new_entitlement_usage"."held" <= 9007199254740991 AND "__new_entitlement_usage"."committed" <= 9007199254740991 - "__new_entitlement_usage"."held")
);
--> statement-breakpoint
...
ALTER TABLE `shop_subscriptions` ADD `revision` integer DEFAULT 1 NOT NULL;